  ...
  const events = [
    {
      ...
      time: "4:00 PM",
      icon: Clock,
      description: "Join us as we exchange vows in the beautiful outdoor garden pavilion, surrounded by blooming flowers and gentle nature sounds.",
      details: [
    ...
    },
    {
      ...
      time: "4:30 PM",
      icon: Utensils,
      description: "Celebrate with us during cocktail hour featuring locally sourced appetizers and signature drinks inspired by our favorite flavors.",
      details: [
    ...
    },
    {
      ...
      time: "6:00 PM",
      icon: Music,
      description: "Dance the night away under string lights with dinner, toasts, and live acoustic music that celebrates our love story.",
      details: [
  ...
  const practicalInfo = [
    {
      icon: MapPin,
      title: "Getting There",
      content: "Willow Creek Gardens is located at 1234 Meadowbrook Lane, just 15 minutes from downtown. Ample parking available on-site."
    },
    {
      icon: Car,
      title: "Accommodations",
      content: "We've reserved blocks at the nearby Meadowbrook Inn and Garden Suites. Book by May 1st for special rates."
    },
    {
      icon: Gift,
      title: "Registry",
      content: "Your presence is the only present we need! But if you'd like to give a gift, we're registered at a few favorite places."
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-cormorant text-xl md:text-2xl text-muted-foreground italic max-w-3xl mx-auto">
            Everything you need to know about our special day, from ceremony to celebration.
          </p>
        </div>
              ...
              <div className="p-8 lg:p-12 flex items-center">
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-6">
                    A picturesque garden venue nestled in the rolling hills of Meadowbrook. Known for its stunning natural beauty, mature oak trees, and carefully curated botanical gardens that bloom year-round.
                  </p>
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <MapPin className="w-5 h-5 text-sage" />
                      <span className="text-muted-foreground">1234 Meadowbrook Lane, Meadowbrook, CA</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Car className="w-5 h-5 text-sage" />
                      <span className="text-muted-foreground">Free parking available on-site</span>
                    </div>
                  </div>
                  <Button 
                    variant="outline"
        ...
        <div className="mt-16 text-center">
          <div className="bg-sage-light/20 rounded-2xl p-8 max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground">
              Our ceremony will be held outdoors rain or shine. We'll have a beautiful covered pavilion ready just in case Mother Nature decides to add her own touch to our special day. We recommend bringing a light jacket for the evening celebration.
            </p>
          </div>
        </div>
      </div>
