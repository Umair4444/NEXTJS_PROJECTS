...
export const projects = [
  ...
  },
  {
    ...
    img: "/p3.svg",
    iconLists: ["/python.svg", "/streamlit.svg", "/uv.webp", "/numpy.webp"],
    link: "/python-projects",
  },
  {
    id: 4,
    title:
      "NextJs Chatting and Blogs Projects – Building with React & Next.js and using ShadCN UI",
    des: "Building web apps with nextjs and using headless CMS for content management with different libraries and framework",
    img: "/p2.svg",
    iconLists: [
      "/ts.svg",
    ...
    link: "/chatting-and-blog-apps",
  },
  {
    id: 5,
    title:
      "NextJs Webs Apps Clone – Building with React & Next.js and using ShadCN UI",
    des: "Building web apps with nextjs and using headless CMS for content management with different libraries and framework",
    img: "/p2.svg",
    iconLists: [
      "/ts.svg",
  ...
  },
  {
    id: 6,
    title:
      "NextJs Utility Web Apps Projects – Building with React & Next.js and using ShadCN UI",
    des: "Building web apps with nextjs and using headless CMS for content management with different libraries and framework",
    img: "/p2.svg",
    iconLists: [
      "/ts.svg",
