        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between gap-8">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <Link href="/products?sale=true" className="hover:text-gray-600">
                On Sale
              </Link>
              <Link href="/products?new=true" className="hover:text-gray-600">
                New Arrivals
              </Link>
            ...
            <div className="flex-1 max-w-md relative">
              ...
              <Input placeholder="Search for products..." className="pl-10 bg-gray-100 border-none rounded-full" />
            </div>
