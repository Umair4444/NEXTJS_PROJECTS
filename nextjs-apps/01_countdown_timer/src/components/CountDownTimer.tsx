...
export default function Countdown() {
  ...
  return (
    // Container div with background image and glass card
    <div
      className="flex items-center justify-center h-screen bg-cover bg-center"
      style={{
        backgroundImage: "url('/timer.jpg')", // Add your image in public/
      }}
    >
      {/* Timer glass card container */}
      <div className="backdrop-blur-md bg-white/10 border border-white/30 rounded-xl shadow-xl p-8 w-full max-w-md text-white">
        {/* Title of the countdown timer */}
        <h1 className="text-3xl font-bold mb-4 text-center">Countdown Timer</h1>
        ...
        <div className="flex items-center mb-6">
          <Input
            ...
            className="flex-1 mr-4 rounded-md bg-white/20 text-white border-white/30 placeholder-white"
          />
          <Button
